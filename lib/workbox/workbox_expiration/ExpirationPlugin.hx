...
@:jsRequire("workbox-expiration", "ExpirationPlugin") extern class ExpirationPlugin {
	function new(?config:ExpirationPluginOptions);
	...
	**/
	@:optional
	dynamic function cacheDidUpdate(param:workbox_core.CacheDidUpdateCallbackParam):js.lib.Promise<Null<ts.Undefined>>;
	/**
	...
	**/
	function deleteCacheAndMetadata():js.lib.Promise<ts.Undefined>;
