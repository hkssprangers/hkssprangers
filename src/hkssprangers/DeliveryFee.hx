...
class DeliveryFee {
    static public final heuristics:Array<DeliveryFeeHeuristric> = [
        ...
        },
        {
            ...
            match: address -> address.contains("海麗邨") || address.contains("海麗村"),
            deliveryFee: cluster -> switch cluster {
                case DragonCentreCluster: 40;
                case PeiHoStreetMarketCluster: 40;
                case CLPCluster: 40;
        ...
        },
        {
            ...
            match: address -> address.contains("中國船舶大廈") ||  address.contains("中國船泊大廈"),
            deliveryFee: cluster -> switch cluster {
                case DragonCentreCluster: 35;
                case PeiHoStreetMarketCluster: 35;
                case CLPCluster: 35;
        ...
        {
            place: "城市的盼望", //南昌街156-158
            osm: [
                {
                    url: "https://www.openstreetmap.org/node/11012205752"
                }
            ],
            match: address -> address.contains("城市的盼望"),
            deliveryFee: cluster -> switch cluster {
                case DragonCentreCluster: 25;
                case PeiHoStreetMarketCluster: 25;
                case CLPCluster: 25;
