            ...
            <Fragment>
                ...
                <main>
                    <div className="p-6 md:mb-32 md:p-0 mx-auto md:w-4/5 max-w-screen-lg">
                        ...
                        <div>
                            <a href="https://docs.google.com/forms/d/e/1FAIpQLScyydoYxadEtvrwgUcplDZjxbHMmV-cCFlKtE0wcwJwb3cl_A/viewform">
                                ${StaticResource.image("/images/rice-dump-form.jpg", "KOLB x 點心紙 x 埗兵", "w-full")}
                            </a>
                        </div>
