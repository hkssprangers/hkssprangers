        ...
        return jsx('
            <fragment>
                ...
                <ol className="list-decimal list-outside pl-4">
                    <li>豆腐用重物壓至少半個鐘出水，切粒</li>
                    <li>青椒切條，薑切片</li>
                    <li>用二茶匙麻油爆香薑片到金黃色，再加豆腐同青椒落鑊炒</li>
                    <li>加二茶匙蠔油，一茶匙糖，一茶匙味醂，炒勻後收細火繼續收汁</li>
                    <li>加入九層塔後炒勻，完成</li>
                </ol>
            </fragment>
        ');
        ...
        return jsx('
            <fragment>
                ...
                <ol className="mb-6 list-decimal list-outside pl-4">
                    <li>先浸洗蘆薈10-15分鐘，確保洗走刺激皮膚嘅大黃素</li>
                    <li>切走兩邊嘅刺同蘆薈頭，再切段，大概4吋一段</li>
                    <li>慢慢片開一邊蘆薈皮，蘆薈𠝹成粒粒，再切落嚟</li>
                    <li>梳打水加入蘆薈肉，檸檬片，新鮮薄荷，完成!</li>
                </ol>
    ...
    function renderBasilTomatoMeat() {
        return jsx('
            <fragment>
                ...
                <ol className="mb-6 list-decimal list-outside pl-4">
                    <li>肉碎用麻油醃一醃，蕃茄切塊</li>
                    <li>預備醬料，一茶匙豆瓣醬，一茶匙蠔油，攪勻</li>
                    <li>開大火先炒肉碎，再加半份蕃茄</li>
                    <li>收細火，加醬料用另外半份蕃茄，煮到收汁，唔夠味再加少少鹽</li>
                    <li>加入九層塔後炒勻，完成</li>
                </ol>
            </fragment>
        ');
    ...
    function renderBitterMelonVegeEgg() {
        return jsx('
            <fragment>
                ...
                <div className="mb-1 text-xs text-gray-400">步驟</div>
                <ol className="mb-6 list-decimal list-outside pl-4">
                    <li>豆腐用重物壓至少半個鐘出水，再用叉壓碎</li>
                    <li>洗乾淨苦瓜後刮走種子同白膜，切薄片</li>
                    <li>怕苦嘅朋友可以拎苦瓜浸鹽水10分鐘</li>
                    <li>預熱個鑊加少少油，先炒豆腐，加入1/2茶匙黃薑粉上色</li>
                    <li>加入苦瓜片一齊炒，加少少鹽同胡椒粉，完成</li>
                </ol>
            </fragment>
        ');
    }
    ...
    function renderCatToast() {
        return jsx('
            <fragment>
                ...
                <div className="mb-1 text-xs text-gray-400">步驟</div>
                <ol className="mb-6 list-decimal list-outside pl-4">
                    <li>酵母加50ml水等待到起泡，代表佢可以開工</li>
                    <li>高筋麵粉，鹽，糖攪均</li>
                    <li>加一半水(45ml)慢慢攪均，再加另一半水(45ml)同菜油攪均</li>
                    <li>加酵母水到麵團，搓成光滑圓形後開始第一次發酵，大概1個鐘，建議放入焗爐，側邊放杯熱水保濕同保溫</li>
                    <li>拎麵團出泥搓搓放氣，放入模具再進行第二次發酵，大約90分鐘，視乎情況，麵團發大到模具8成滿就可以開始焗</li>
                    <li>180度焗大概25分鐘，視乎情況調整</li>
                    <li>切包，加果醬，完成</li>
                </ol>
                <div className="mb-1 text-xs text-gray-400">備註</div>
                <p>純素配方建議份量:</p>
    ...
    function renderCauliflower() {
        return jsx('
            <fragment>
                ...
                <div className="mb-1 text-xs text-gray-400">步驟</div>
                <ol className="list-decimal list-outside pl-4">
                    <li>用少少鹽、油、孜然粉、煙燻甜紅椒粉，搽均晒切好嘅椰菜花同薯仔</li>
                    <li>加牛油紙蓋面，200度焗20分鐘</li>
                    <li>拎走牛油紙，加芝士，再焗5分鐘</li>
                </ol>
            </fragment>
        ');
    }
    ...
    function renderCurry() {
        return jsx('
            <fragment>
                ...
                <div className="mb-1 text-xs text-gray-400">步驟</div>
                <ol className="list-decimal list-outside pl-4">
                    <li>1湯匙黃薑粉加半湯匙孜然粉炒配菜(薯仔/甘荀/青椒/翠玉瓜/雪櫃有嘅菜)</li>
                    <li>1湯匙素蠔油加250ml水，加落鑊中火煮8分鐘煮腍薯仔</li>
                    <li>加250ml椰奶，細火煮8分鐘收水</li>
                </ol>
            </fragment>
        ');
    }
    ...
    function renderKaleCrisp() {
        return jsx('
            <fragment>
                ...
                <div className="mb-1 text-xs text-gray-400">步驟</div>
                <ol className="list-decimal list-outside pl-4">
                    <li>洗淨羽衣甘藍後fing乾水，葉片搣開細細塊，唔要中間嘅芯</li>
                    <li>用少量油搽均葉面，可以加少少鹽</li>
                    <li>搵個焗盤放羽衣甘藍，盡量舖平唔重疊，160度焗大約10分鐘，視乎葉片水分抽乾晒未</li>
                </ol>
            </fragment>
        ');
    }
        ...
        return jsx('
            <fragment>
                ...
                <ol className="mb-6 list-decimal list-outside pl-4">
                    <li>蕃茄同冬瓜切片，腰果洗乾淨</li>
                    <li>用油炒一炒蕃茄到稍稍變稔</li>
                    <li>加入冬瓜，腰果，水，中火滾20分鐘，加少少鹽，完成</li>
                </ol>
                <div className="mb-1 text-xs text-gray-400">備註</div>
                <p>2人建議份量:</p>
                <ul className="list-disc list-outside pl-4">
    ...
    function renderMisoEggplant() {
        return jsx('
            <fragment>
                ...
                <div className="mb-1 text-xs text-gray-400">步驟</div>
                <ol className="mb-6 list-decimal list-outside pl-4">
                    <li>茄子對半切再𠝹一格格，用鹽醃一醃</li>
                    <li>預備醬料，一茶匙味噌，一茶匙豉油，一茶匙味醂，一茶匙糖，攪勻</li>
                    <li>茄子皮向上，焗180度10分鐘</li>
                    <li>茄子肉向上，搽上醬料，加上芝麻，焗180度5分鐘，完成</li>
                </ol>
            </fragment>
        ');
    }
    function renderNinePie() {
        return jsx('
            <fragment>
                ...
                <div className="mb-1 text-xs text-gray-400">步驟</div>
                <ol className="mb-6 list-decimal list-outside pl-4">
                    <li>韮菜清洗，抹乾後以半吋大小切粒</li>
                    <li>榨菜切粒</li>
                    <li>打發雞蛋，加入少量胡椒粉以及韮菜榨菜拌勻</li>
                    <li>平底鍋加1湯匙油，加入蛋漿以中火煎，成型後翻面再煎香，完成</li>
                </ol>
                <div className="mb-1 text-xs text-gray-400">備註</div>
                <p>2底建議份量:</p>
                <ul className="list-disc list-outside pl-4">
    ...
    function renderPotatoCheese(){
        return jsx('
            <fragment>
                ...
                <ol className="mb-6 list-decimal list-outside pl-4">
                    <li>洗淨薯仔批皮切片（半cm厚)</li>
                    <li>常溫水加鹽煲煮，大火冚蓋至水滾，水滾後中火冚蓋煮10分鐘，腍就拎起隔水</li>
                    <li>放兜趁熱壓爛成薯蓉</li>
                    <li>之後加粟粉、鹽、糖、黑椒撈勻</li>
                    <li>攤凍薯蓉時預備定芝士</li>
                    <li>放暖薯蓉後分10份</li>
                    <li>撳扁後中間放芝士慢慢搓至埋口，捏至圓轆狀</li>
                    <li>平底鑊中火熱油後每面煎4分鐘至兩面金黃</li>
                </ol>
                <div className="mb-1 text-xs text-gray-400">備註</div>
    ...
    function renderSandMiso(){
        return jsx('
            <fragment>
                ...
                <ol className="list-decimal list-outside pl-4">
                    <li>1.幫沙葛同甘荀去皮切片</li>
                    <li>2.預備醬料，二茶匙味噌，一茶匙豉油，一茶匙味醂，一茶匙糖 ，加少少水攪勻</li>
                    <li>3.熱鑊加少少油，先炒稔沙葛甘荀，加芋絲，再加醬料，炒到芋絲上色，完成</li>
                </ol>
            </fragment>
        ');
    }
    function renderShisoTomato(){
        return jsx('
            <fragment>
                ...
                <div className="mb-1 text-xs text-gray-400">步驟</div>
                <ol className="list-decimal list-outside pl-4">
                    <li>蕃茄仔洗乾淨切半，用鹽醃至少半個鐘出水</li>
                    <li>紫蘇葉切條</li>
                    <li>倒走多餘嘅水，蕃茄仔加二茶匙橄欖油，加紫蘇葉，攪勻，完成，未食前可以雪凍再食仲爽口</li>
                </ol>
            </fragment>
        ');
    }
    ...
    function renderSoup(){
        return jsx('
            <fragment>
                ...
                <div className="mb-1 text-xs text-gray-400">步驟</div>
                <ol className="list-decimal list-outside pl-4">
                    <li>洗淨粟米、紅菜頭、西芹、蘋果、薑、腰果(約半碗)</li>
                    <li>所有配料放晒落水，開大火到水滾後改用細火煲1個鐘</li>
                    <li>熄火，加少少鹽</li>
                </ol>
            </fragment>
        ');
        ...
        return jsx('
            <fragment>
                ...
                <ol className="list-decimal list-outside pl-4">
                    <li>烚好螺絲粉，瓊乾水備用</li>
                    <li>切碎洋蔥、菠菜苗、煙肉</li>
                    <li>中火炒洋蔥到半透明，加入煙肉一齊炒</li>
                    <li>預備100ml豆漿加二茶匙味噌攪均，收細火後加入</li>
                    <li>加螺絲粉同菠菜苗，煮到收汁，完成</li>
                </ol>
            </fragment>
        ');
    }
        ...
        return jsx('
            <fragment>
                ...
                <ol className="list-decimal list-outside pl-4">
                    <li>洗乾淨苦瓜後刮走種子同白膜，切薄片</li>
                    <li>怕苦嘅朋友可以拎苦瓜浸鹽水10分鐘</li>
                    <li>預備滾水，苦瓜煮1-2分鐘後拎起</li>
                    <li>冰鎮苦瓜保持脆卜卜嘅口感</li>
                    <li>加入1湯匙醋，1湯匙豉油，1茶匙糖做調味，食得辣可以再加七味粉或乾辣椒，完成</li>
                </ol>
            </fragment>
        ');
    }
