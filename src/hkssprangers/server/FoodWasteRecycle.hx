        ...
        return jsx('
            <main>
                <div className="bg-coffee">
                    <div className="bg-contain bg-no-repeat bg-top bg-coffee-banner">
                        ...
                        <div className="px-6 py-12 mx-auto container text-center">
                        ...
                        <div className="py-12 mx-auto w-4/5 md:flex flex-row md:flex-row-reverse">
                            <div className="flex-1">
                ...
                <div className="py-12 mx-auto w-4/5 md:flex">
                    ...
                    <div className="flex-1 p-6 md:p-12 text-opacity-75 text-gray-700">
                        <h1 className="text-2xl md:text-4xl font-bold pb-3 text-opacity-75 text-yellow-800 tracking-wider">後記</h1>
