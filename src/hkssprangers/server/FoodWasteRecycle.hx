            ...
            <main>
                ...
                <div className="">
                    <div className="px-6 py-12 mx-auto lg:max-w-screen-2xl text-center overflow-hidden">
                        ...
                        <div className="grid grid-cols-5 grids-rows-10 md:grid-cols-10 md:grids-rows-4" >
                            ...
                            <div className="row-start-4 row-span-3 col-start-1 col-span-3 md:row-start-3 md:row-span-3 md:col-start-7 md:col-span-4 -ml-16 md:ml-0">
                                ${image("/images/food-waste-recycle/b3.png", "菜苗", "cup3")}
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="mx-auto p-6 md:p-12">
                            ...
                            <div className="lg:flex container relative text-opacity-75 text-gray-700">
                                <div className="flex-1 lg:grid lg:grid-cols-5 lg:grid-rows-5">
                                    <div className="w-2/3 lg:w-full lg:row-start-4 lg:row-span-2 lg:col-start-1 lg:col-span-2 mx-auto -mb-16 lg:mb-0 lg:-ml-12 z-10">${image("/images/food-waste-recycle/coffee-cup.png", "cup", "")}</div>
                                    <div id="bowl" className="w-32 absolute bottom-0 z-20 hidden lg:block">${image("/images/food-waste-recycle/bowl.gif", "bowl", "")}</div>
                                ...
                                <div className="flex-1 lg:grid lg:grid-cols-5 lg:grid-rows-5">
                                    <div className="w-2/3 lg:w-full lg:row-start-4 lg:row-span-2 lg:col-start-4 lg:col-span-2 mx-auto -mb-16 lg:mb-0 lg:ml-12 z-10">${image("/images/food-waste-recycle/compost.gif","compost","")}</div>
                    ...
                    <div className="relative bg-earth">
                        ...
                        <div id="farmer" className="w-1/2 md:w-1/3 lg:w-1/4">${image("/images/food-waste-recycle/f-b.png","farmer","")}</div>
                    </div>
