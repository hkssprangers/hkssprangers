...
class View extends ReactComponent {
    ...
    function favicon() return jsx('
        <Fragment>
            <link rel="apple-touch-icon" sizes="720x720" href=${R("/images/ssprangers22.jpg")}/>
            <link rel="icon" type="image/png" sizes="720x720"  href=${R("/images/ssprangers22.jpg")}/>
            <meta name="msapplication-TileColor" content="#ffffff" />
            <meta name="msapplication-TileImage" content=${R("/images/ssprangers22.jpg")} />
