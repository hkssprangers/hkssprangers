...
enum abstract Shop(String) to String {
    ...
    public function checkAvailability(currentTime:Date, pickupTimeSlot:TimeSlot):Availability {
        ...
        switch [(cast this:Shop), pickupTimeSlot.start.getDatePart(), TimeSlotType.classify(pickupTimeSlot.start)] {
            ...
            case [EightyNine, "2023-04-04" | "2023-04-05", _]:
                return Unavailable('休息');
            case [ThaiHome, "2023-04-03" | "2023-04-04" | "2023-04-05", _]:
                return Unavailable('休息');
            ...
            // https://www.facebook.com/permalink.php?story_fbid=pfbid08YC3Z2La8c7ZG7XwzRLEAYYoVFor2fdsedgY1MFq5dT81sGZQjKDdMRB3R1JJ8n4l&id=100064143817671
            case [KCZenzero, "2023-04-12", Dinner]:
                return Unavailable('應付團購 晚市暫停一天');

            case [Minimal, "2023-04-10" | "2023-04-11", _]:
                return Unavailable('因包場活動暫停營業');
