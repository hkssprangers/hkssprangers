...
enum abstract Shop(String) to String {
    ...
    public function checkAvailability(currentTime:Date, pickupTimeSlot:TimeSlot):Availability {
        ...
        switch [(cast this:Shop), pickupTimeSlot.start.getDatePart(), TimeSlotType.classify(pickupTimeSlot.start)] {
            ...
            // https://www.facebook.com/permalink.php?story_fbid=pfbid02BJC7TZLh2j82ESm61tvfrXm5bLaxFQtQZBuYejgb3YytyuvLJKAJSNVT3aaRgxpnl&id=100064143817671
            case [KCZenzero, "2022-10-16", _]:
            ...
            // https://www.facebook.com/LaksaStore/posts/pfbid02dzF46xsRdeAXg9vvbNjXiWJFfSHer3Ab54BhjV7XBEy7M1x71ANuqwSSKhtDNuVcl
            case [LaksaStore, "2022-10-12", _]:
                return Available;
            case [LaksaStore, "2022-10-13", _]:
                return Unavailable('休息一天');
