...
enum abstract Shop(String) to String {
    ...
    public function checkAvailability(currentTime:Date, pickupTimeSlot:TimeSlot):Availability {
        ...
        switch [(cast this:Shop), pickupTimeSlot.start.getDatePart(), TimeSlotType.classify(pickupTimeSlot.start)] {
            ...
            // https://www.facebook.com/openblackwindow/posts/pfbid0u2s25CX1LyzQoJB5PNnzqJsYb1b4YEFQ7Vihb45anuJRcjBXz69HeZbgQ6swzsa2l
            case [BlackWindow, "2022-12-06"| "2022-12-11", Dinner]:
            ...
            case [ThaiHome, "2022-12-21", _]:
                return Unavailable('休息一天');

            case [ThaiHome, "2022-12-25", _]:
                return Unavailable('休息一天');

            case [EightyNine, "2022-12-25", Dinner]:
